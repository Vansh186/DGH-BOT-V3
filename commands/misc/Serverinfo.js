...
module.exports = {
  ...
  run: async (client, message, args) => {
    ...
    message.guild.channels.cache.filter(
      ...
      "AFK Timeout", `${message.guild.afkTimeout / 60} minutes`, true)
      "AFK Channel",
        `${
          ...
          message.guild.afkChannelID === null ? "" : message.guild.afkChannelID
        })`,
        true
      )
      Location", message.guild.region, true)
      Created", message.guild.createdAt.toLocaleString(), true)
